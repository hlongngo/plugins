...
/// An event fired when the Camera of a [mapId] starts moving.
class MapSnapshotReadyEvent extends MapEvent<void> {
  /// Build a MapSnapshotReadyEvent Event triggered from the map represented by `mapId`.
  MapSnapshotReadyEvent(int mapId) : super(mapId, null);
}
